...
//       {
//           id: 0,
//           video: "http://192.168.2.6:19787/api/video/url/3cca91d6f6524079.mp4",
...
// const VideoPlayer = React.memo((props: ShortVideoItemProps) => {
...
//     {
//       data
//         ? <Video source={{ uri: Content?.video }}
...
//         <Image
//           style={styles.icon}
//           source={data?.hasFavor ? require('../../assets/images/i_search.png') : require('../../assets/images/i_search.png')}
//         />
//       </TouchableWithoutFeedback>
